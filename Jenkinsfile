        ...
        stage('Upload to TestFlight') {
            ...
            steps {
                ansiColor('xterm') {
                    ...
                    sh 'INFURA_KEY=\"${INFURA_PROD_KEY}\" SSL_ENFORCE_PINNING=\"${SSL_ENFORCE_PINNING}\" WALLETCONNECT_PROJECT_ID=\"${WALLETCONNECT_PROJECT_ID_PROD}\" WEB3AUTH_GOOGLE_CLIENT_ID=\"${WEB3AUTH_GOOGLE_CLIENT_ID_PROD}\" WEB3AUTH_GOOGLE_VERIFIER=\"${WEB3AUTH_GOOGLE_VERIFIER_PROD}\" INTERCOM_APP_ID=\"${INTERCOM_PROD_APP_ID}\" INTERCOM_API_KEY=\"${INTERCOM_PROD_API_KEY}\" MOONPAY_API_KEY=\"${MOONPAY_PROD_API_KEY}\" bin/archive.sh \"Multisig - Production\"'
                    sh 'INFURA_KEY=\"${INFURA_STAGING_KEY}\" SSL_ENFORCE_PINNING=\"${SSL_ENFORCE_PINNING}\" WALLETCONNECT_PROJECT_ID=\"${WALLETCONNECT_PROJECT_ID_STAGING}\" WEB3AUTH_GOOGLE_CLIENT_ID=\"${WEB3AUTH_GOOGLE_CLIENT_ID_STAGING}\" WEB3AUTH_GOOGLE_VERIFIER=\"{WEB3AUTH_GOOGLE_VERIFIER_STAGING}\" INTERCOM_APP_ID=\"${INTERCOM_STAGING_APP_ID}\" INTERCOM_API_KEY=\"${INTERCOM_STAGING_API_KEY}\" MOONPAY_API_KEY=\"${MOONPAY_STAGING_API_KEY}\" bin/archive.sh \"Multisig - Staging\"'
