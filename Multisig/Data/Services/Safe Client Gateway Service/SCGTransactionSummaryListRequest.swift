...
extension SafeClientGatewayService {
    ...
    func transactionSummaryList(pageUri: String) throws -> SCGTransactionSummaryListRequest.ResponseType {
        return try execute(request: SCGPagedRequest<SCGTransactionSummary>(pageUri))
    }
}
