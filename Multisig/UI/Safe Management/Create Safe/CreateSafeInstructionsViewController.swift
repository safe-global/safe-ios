...
class CreateSafeInstructionsViewController: InstructionsViewController {
    ...
    override func viewDidLoad() {
        ...
        steps = [
            ...
            .step(number: "4", title: "Pay network fee", description: "A network fee is required for creation, as Safe is a smart contract. Gnosis doesn’t profit from the fees."),
