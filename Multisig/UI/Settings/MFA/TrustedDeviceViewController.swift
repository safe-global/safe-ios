...
class TrustedDeviceViewController: LoadableViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    enum Section {
        ...
        enum Factor: SectionItem {
            case factor(String, String, String, String)
        }
    ...
    private func buildSections() {
        ...
        sections.append(SectionItems(section: .factor,
                                     items: [Section.Factor.factor("iPhone Pro Max",
                                                                   "This device",
                                                                   "iOS 16.2 · Last login: 16.07.2023",
                                                                   "ico-mobile")]))
        ...
        header.set("Your current device is used to store the key share of your owner. You can use this email to confirm it’s you during recovery.", centered: true, linesCount: 3, backgroundColor: .backgroundPrimary)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .factor:
            if case let Section.Factor.factor(name, value, details, image) = factor {
