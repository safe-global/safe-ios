...
// In iOS 14 there is TextEditor component.
// To support lower iOS versions we need to use UIViewRepresentable

// https://github.com/kenmueller/TextView
// Latest commit faca465 on 17 Jun
// MIT License
// Included as a source file as it only supports SwiftPM
