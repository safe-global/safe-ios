...
sed -i '' "s/YOUR_WALLETCONNECT_PROJECT_ID/${WEB3AUTH_GOOGLE_CLIENT_ID}/g" "${CONFIG_FILE}"
sed -i '' "s/YOUR_WALLETCONNECT_PROJECT_ID/${WEB3AUTH_GOOGLE_VERIFIER}/g" "${CONFIG_FILE}"
